...
// WithPage adds the page to the list site forms params
func (o *ListSiteFormsParams) WithPage(page *int32) *ListSiteFormsParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the list site forms params
func (o *ListSiteFormsParams) SetPage(page *int32) {
	o.Page = page
}

// WithPerPage adds the perPage to the list site forms params
func (o *ListSiteFormsParams) WithPerPage(perPage *int32) *ListSiteFormsParams {
	o.SetPerPage(perPage)
	return o
}

// SetPerPage adds the perPage to the list site forms params
func (o *ListSiteFormsParams) SetPerPage(perPage *int32) {
	o.PerPage = perPage
}
