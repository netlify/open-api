...
func (o *ListSiteAgentRunnerHooksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListSiteAgentRunnerHooksOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewListSiteAgentRunnerHooksDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewListSiteAgentRunnerHooksOK() *ListSiteAgentRunnerHooksOK {
	return &ListSiteAgentRunnerHooksOK{}
}
...
func (o *ListSiteAgentRunnerHooksOK) Error() string {
	return fmt.Sprintf("[GET /sites/{site_id}/agent_runner_hooks][%d] listSiteAgentRunnerHooksOK  %+v", 200, o.Payload)
}
...
func (o *ListSiteAgentRunnerHooksOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewListSiteAgentRunnerHooksDefault(code int) *ListSiteAgentRunnerHooksDefault {
	return &ListSiteAgentRunnerHooksDefault{
		_statusCode: code,
	}
}
...
func (o *ListSiteAgentRunnerHooksDefault) Error() string {
	return fmt.Sprintf("[GET /sites/{site_id}/agent_runner_hooks][%d] listSiteAgentRunnerHooks default  %+v", o._statusCode, o.Payload)
}
...
func (o *ListSiteAgentRunnerHooksDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
