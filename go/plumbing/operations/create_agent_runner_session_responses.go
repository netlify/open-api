...
func (o *CreateAgentRunnerSessionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateAgentRunnerSessionOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 404:
		result := NewCreateAgentRunnerSessionNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 422:
		result := NewCreateAgentRunnerSessionUnprocessableEntity()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewCreateAgentRunnerSessionDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *CreateAgentRunnerSessionOK) Error() string {
	return fmt.Sprintf("[POST /agent_runners/{agent_runner_id}/sessions][%d] createAgentRunnerSessionOK  %+v", 200, o.Payload)
}
...
func (o *CreateAgentRunnerSessionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCreateAgentRunnerSessionNotFound() *CreateAgentRunnerSessionNotFound {
	return &CreateAgentRunnerSessionNotFound{}
}
...
func (o *CreateAgentRunnerSessionNotFound) Error() string {
	return fmt.Sprintf("[POST /agent_runners/{agent_runner_id}/sessions][%d] createAgentRunnerSessionNotFound ", 404)
}

func (o *CreateAgentRunnerSessionNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCreateAgentRunnerSessionUnprocessableEntity() *CreateAgentRunnerSessionUnprocessableEntity {
	return &CreateAgentRunnerSessionUnprocessableEntity{}
}
...
func (o *CreateAgentRunnerSessionUnprocessableEntity) Error() string {
	return fmt.Sprintf("[POST /agent_runners/{agent_runner_id}/sessions][%d] createAgentRunnerSessionUnprocessableEntity ", 422)
}

func (o *CreateAgentRunnerSessionUnprocessableEntity) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCreateAgentRunnerSessionDefault(code int) *CreateAgentRunnerSessionDefault {
	return &CreateAgentRunnerSessionDefault{
		_statusCode: code,
	}
}
...
func (o *CreateAgentRunnerSessionDefault) Error() string {
	return fmt.Sprintf("[POST /agent_runners/{agent_runner_id}/sessions][%d] createAgentRunnerSession default  %+v", o._statusCode, o.Payload)
}
...
func (o *CreateAgentRunnerSessionDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
