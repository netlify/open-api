...
func (o *RestoreSiteDatabaseSnapshotReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRestoreSiteDatabaseSnapshotOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewRestoreSiteDatabaseSnapshotDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewRestoreSiteDatabaseSnapshotOK() *RestoreSiteDatabaseSnapshotOK {
	return &RestoreSiteDatabaseSnapshotOK{}
}
...
func (o *RestoreSiteDatabaseSnapshotOK) Error() string {
	return fmt.Sprintf("[POST /sites/{site_id}/database/snapshot/{snapshot_id}/restore][%d] restoreSiteDatabaseSnapshotOK ", 200)
}

func (o *RestoreSiteDatabaseSnapshotOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewRestoreSiteDatabaseSnapshotDefault(code int) *RestoreSiteDatabaseSnapshotDefault {
	return &RestoreSiteDatabaseSnapshotDefault{
		_statusCode: code,
	}
}
...
func (o *RestoreSiteDatabaseSnapshotDefault) Error() string {
	return fmt.Sprintf("[POST /sites/{site_id}/database/snapshot/{snapshot_id}/restore][%d] restoreSiteDatabaseSnapshot default  %+v", o._statusCode, o.Payload)
}
...
func (o *RestoreSiteDatabaseSnapshotDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
