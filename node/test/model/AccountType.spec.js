...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDefinition.AccountType();
  });
  ...
  describe('AccountType', function() {
    it('should create an instance of AccountType', function() {
      ...
      //var instane = new NetlifysApiDefinition.AccountType();
      //expect(instance).to.be.a(NetlifysApiDefinition.AccountType);
    });
