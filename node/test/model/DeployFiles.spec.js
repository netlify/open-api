...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDefinition.DeployFiles();
  });
  ...
  describe('DeployFiles', function() {
    it('should create an instance of DeployFiles', function() {
      ...
      //var instane = new NetlifysApiDefinition.DeployFiles();
      //expect(instance).to.be.a(NetlifysApiDefinition.DeployFiles);
    });
