...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDefinition.PaymentMethodData();
  });
  ...
  describe('PaymentMethodData', function() {
    it('should create an instance of PaymentMethodData', function() {
      // uncomment below and update the code to test PaymentMethodData
      //var instane = new NetlifysApiDefinition.PaymentMethodData();
      //expect(instance).to.be.a(NetlifysApiDefinition.PaymentMethodData);
    });
