...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDefinition.AccountUsageCapability();
  });
  ...
  describe('AccountUsageCapability', function() {
    it('should create an instance of AccountUsageCapability', function() {
      // uncomment below and update the code to test AccountUsageCapability
      //var instane = new NetlifysApiDefinition.AccountUsageCapability();
      //expect(instance).to.be.a(NetlifysApiDefinition.AccountUsageCapability);
    });
