...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDefinition.AssetSignature();
  });
  ...
  describe('AssetSignature', function() {
    it('should create an instance of AssetSignature', function() {
      // uncomment below and update the code to test AssetSignature
      //var instane = new NetlifysApiDefinition.AssetSignature();
      //expect(instance).to.be.a(NetlifysApiDefinition.AssetSignature);
    });
